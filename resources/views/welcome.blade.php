...
@section('content')
    <section class="w3l-main-slider" id="home">
        <div class="banner-content">
            <div id="demo-1"
                data-zs-src='["images/6.jpg", "images/7.jpg","images/8.jpeg", "images/9.jpg"]'
                    ...
                    <div class="container">
                        <div class="banner-infhny">
                            ...
                            <div id="new-year"><svg id="new-year-svg" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <polyline id="happy-stroke" class="stroke-fill" clip-path="url(#happy-clip)"
                                        fill="none" stroke="#4F2525" stroke-width="6" stroke-linejoin="round"
                                        stroke-miterlimit="10"
                                        points="193.458,17.771 193.479,41.896 206.625,45.542 206.667,18.667 186.917,26.5 195,29.667 204.917,29.625 212.562,48.75 219.344,43.438 228.229,14.438 237.188,43.958 223.375,42.25 216.188,34.625 239.208,34.583 243.875,44.292 249.938,44.062 249.833,20.312	249.833,21.979 258.396,22.417 261.333,25.604 260.042,29.417 255.896,30.562 251.125,30.875 259.833,38.292 270.542,44.542	275.667,42.833 275.708,20.312 275.583,22.167 283.833,22.25 287.042,24.604 286.25,29.083 281.812,30.75 277.688,30.708 296.188,14.438 307.247,33.146 307.375,41.5 304.25,35.75 316.229,17.958 	" />

                                    <path id="underline-stroke" class="stroke-fill" clip-path="url(#underline-clip)"
                                        fill-rule="evenodd" clip-rule="evenodd" fill="none" stroke="#601B1B"
                                        stroke-width="12" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-miterlimit="10"
                                        d="M494,191.5c0,0-134.006-0.858-164-1s-327.5,0-327.5,0" />
                                    <path id="n-stroke" class="stroke-fill" clip-path="url(#new-clip)" fill="none"
                                        stroke="#4F2525" stroke-width="10" stroke-linejoin="round"
                                        stroke-miterlimit="10"
                                        d="M82.5,100c-11.333-11.833-18.621-46.594,0.917-44.583c20.25,2.083,11.167,80,11.167,80s8.583-75.667,31.917-73.333c21.756,2.176-6.892,58.902,2,69.417c11.417,13.5,17.917-1.75,17.917-1.75" />
                                    <path id="ew-stroke" class="stroke-fill" clip-path="url(#new-clip)" fill="none"
                                        stroke="#4F2525" stroke-width="9" stroke-linejoin="round" stroke-miterlimit="10"
                                        d="M155.042,111.083c5.625,0.042,19.125-14.708,11.833-22c-3.387-3.387-16.441,5.794-16.188,22.979c0.25,16.938,11.438,21.812,15.062,17c2.025-2.688,12.312-40.062,14.688-39.688c1.736,0.274-7.229,36.493-0.625,37.625c6.562,1.125,15.489-38.206,15.688-38.312c8.872-4.745-3.562,22.438,3.375,35.375c1.632,3.043,2.985,5.177,7.5,4.125c15.562-3.625,6.312-48.25,6.312-48.25" />
                                    <path id="y-stroke" class="stroke-fill" clip-path="url(#y-clip)" fill="none"
                                        stroke="#4F2525" stroke-width="10" stroke-linejoin="round"
                                        stroke-miterlimit="10"
                                        d="M245.667,105.833c-5.75-14.5-0.334-55.263,21.5-48.25C280.917,62,254.028,129.803,267,130.25c24.167,0.833,40-62.625,36-62.25s22,105.75-19.625,104" />
                                    <path id="ye-stroke" class="stroke-fill" clip-path="url(#ye-clip)" fill="none"
                                        stroke="#4F2525" stroke-width="9" stroke-linejoin="round" stroke-miterlimit="10"
                                        d="M286.125,172.125c-4.875,0.125-9.375-2-11.5-14.25s18.5-35.75,24-40.625s16.503-5.341,26.25-6.375c8.25-0.875,16.25-11,15.5-16.375c-1.471-10.542-8.125-8.875-12.375-6.125" />
                                    <path id="ear-stroke" class="stroke-fill" clip-path="url(#ear-clip)" fill="none"
                                        stroke="#4F2525" stroke-width="9" stroke-linejoin="round" stroke-miterlimit="10"
        ...
        <div class="covers14-block py-5">
            <div class="container py-md-5 py-4">
                ...
                <div class="covers14-text text-center mx-auto py-lg-5" style="max-width:780px">
                    <h4>Service de MASSALI EVENTS!</h4>
                    <p class="mt-3 sub-title">Sed ut perspiciatis unde omnis iste natus error sit olupt atem accusantium
                        dolo remque lauda ntium,
                        totam rem aperiam.</p>
                    <a href="about.html" class="btn btn-style mt-5">Savoir plus</a>
                </div>
            </div>
        </div>
    </section>
                ...
                <span style="--i:9">e</span>
                      ...
                      @auth
                            <table class="container">
                                <thead>
                                    <tr>
                                        <th><h1>Date de l'evènement</h1></th>
                                        <th><h1>Zone de l'evènement</h1></th>
                                        <th><h1>Nom de l'evènement</h1></th>
                                        <th><h1>Action</h1></th>
                                    </tr>
                                </thead>
                                <tbody>
                                ...
                                @forelse ($events as $event)
                                    <tr>
                                        <td>{{date_formater($event->start_time)["jourMois"]}} <span> {{date_formater($event->start_time)["mois"]}} <em>  {{date_formater($event->start_time)["annee"]}}</td>
                                        <td>{{$event->zone}}</td>
                                        <td><h1 style="font-weight:bold; font-size:15px;"><a href="{{route('show_event',$event->id)}}">{{$event->event_name}}</h1></td>
                                        <td><a href="{{route('event_ticket_all',$event->id)}}" class="btn btn-sucess">Buy Ticket</td>
                                    </tr>
                                    @empty
                     ...
                     <h1 style="color:red; font-size:20px; margin-left: auto; margin-right: auto;">Veuillez vous connecter</h1>
    ...
    <!-- services section -->
    <section class="w3l-content-11-main position-relative" id="service">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="services-single d-flex p-sm-5 p-4 mb-0">
                                ...
                                <div class="services-content">
                                    <h5><a href="services.html">Savoir plus sur l'evolution</a></h5>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean egestas magna at
                                        porttitor vehicula nullam augue ipsum dolor.</p>
                                </div>
                            </div>
